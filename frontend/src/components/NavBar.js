    ...
    <div>
         ...
         <div className=' flex flex-row  justify-between w-screen h-24 bg-neutral-950' >
          <div className='left text-red-500 font-bold font-Handjet tracking-wider text-6xl top-5 left-10 relative '>
            <p className='text-white'><span className='text-red-500' >Expense</span> Tracker</p>  
          </div>
        ...
        <div className='pl-4 mr-16 pr-4 w-auto  rounded-xl mt-6 mb-6 '>
            ...
            <div>
                  ...
                  <span className="absolute flex items-center justify-center w-full h-full text-blue-500 transition-all duration-300 transform group-hover:translate-x-full ease">LogOut</span>
